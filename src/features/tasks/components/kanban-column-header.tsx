...
const statusIconMap: Record<TaskStatus, React.ReactNode> = {
  [TaskStatus.BACKLOG]:(<CircleDashedIcon className="size-[18px] text-pink-500"/>),
  [TaskStatus.TODO]:(<CircleIcon className="size-[18px] text-yellow-500"/>),
  [TaskStatus.IN_PROGRESS]:(<CircleDotDashedIcon className="size-[18px] text-red-500"/>),
  [TaskStatus.IN_REVIEW]:(<CircleDotIcon className="size-[18px] text-green-300"/>),
  [TaskStatus.DONE]:(<CircleCheckIcon className="size-[18px] text-emerald-600"/>),
}
